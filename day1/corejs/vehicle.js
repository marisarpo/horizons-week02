...
var teslaS = new Vehicle("teslaS", 2017, "red", snowTires);// =  YOUR CODE HERE

// Create a "jeep" variable that contains a new vehicle called "jeep" that has "allSeasonTires" and a "white" color.

var jeep = new Vehicle('jeep', 2010, "yellow", allSeasonTires)// =  YOUR CODE HERE
...
// YOUR CODE HERE
jeep.whichTires = function(tireType){

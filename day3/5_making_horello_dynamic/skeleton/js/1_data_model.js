...
horello.List.prototype = {
  ...
  addCard: function(name, desc) {
    this.cards.push(new horello.Card(name,desc,this.id));
    return this.cards[this.cards.length - 1].getId();
  },
  ...
  getCard: function(cardId) {
    ...
    while (i < this.cards.length) {
      if (this.cards[i].getId() === cardId) return this.cards[i];
      i++;
    }
    return null;
  },
  ...
  rmvCard: function(cardId) {
    ...
    var i = 0;
    while (i < this.cards.length) {
      if (this.cards[i].getId() === cardId) return this.cards.splice(i,1)[0];
      i++;
    }
    return null;
  }
...
horello.Board.prototype = {
  ...
  getList: function(listId) {
    ...
    while (i < this.lists.length) {
      if (this.lists[i].getId() === listId) return this.lists[i];
      i++;
    }
    return null;
  },
  ...
  rmvList: function(listId) {
    ...
    var i = 0;
    while (i < this.lists.length) {
      if (this.lists[i].getId() === listId) return this.lists.splice(i,1)[0];
      i++;
    }
    return null;
  }

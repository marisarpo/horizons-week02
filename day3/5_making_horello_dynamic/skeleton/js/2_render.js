...
horello.Card.prototype.render = function() {
  // build wrappers
  var wrapper = $('<div></div>');
  var cardwrapper = $('<div data-toggle= "modal" data-target="#cardEdit" class="card" data-list-id="'+this.listId+'" data-card-id="'+this.id+'"></div>');
...
horello.List.prototype.render = function() {
  ...
  listFooter.append($('\
      ...
      <button type="button" class="btn btn-default saveButton" id="addCardBtn'+this.id+'">\
      Save\
      </button>\

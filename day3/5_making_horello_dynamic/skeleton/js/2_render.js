...
horello.List.prototype.render = function() {
 ...
 var footercontent = $('<button class="list-button add-card" data-toggle="collapse" href="#"'+this.id+'>Add a card...</button><div class="collapse" id="'+this.id+
                   '<div class="well add-card-form">'+
                       '<input type="text" class="form-control" placeholder="Card title" id="list_name_'+this.getId()+'">' +
                       '<button type="button" class="btn btn-default" data-list-id='>this.getId()'</button>'+
                       '<button type="button"class="btn btn-default" id="addCardCancel" data-list-id"'+this.getId()+ "><span class='glyphicon glyphicon-remove'></span></button></div></div>'");

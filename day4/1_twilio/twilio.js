...
twilio.accountId = "AC6093bbdfa15ca4cefb14aaaf2e2efd0a";
twilio.authToken = "0046ab3cbc02563247711f02a3f38ca2";
twilio.fromNumber = "18562834354";
...
twilio.TwilioShoutout.prototype = {
  ...
  validatePhoneField: function(phoneStr) {
    ...
    if (phoneStr.trim()===""){return false}
    for (var i=0;i<phoneStr.length;i++){
      if (phoneStr[i].isNan){return false}
    }
    return true
  },
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    var cb = function(data) {
			// YOUR CODE HERE
      var newMessage=new Message(this.fromNumber,messageBody);
      var listelement=newMessage.render()

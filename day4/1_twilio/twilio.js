...
twilio.accountId = "ACe526bc0131e8a2847902e48075c1f430";
twilio.authToken = "035138914bb27389564ade8b257254dd";
twilio.fromNumber = "+14159428248";
...
twilio.TwilioShoutout.prototype = {
  ...
  initialize: function() {
    // YOUR CODE HERE //question about BIND
    // var self = this;
    // this.messageSendButton.click(self.handleMessageSend(event));
  ...
  validatePhoneField: function(phoneStr) {
    if(phoneStr.length === 0 || phoneStr.trim().length === 0 || isNaN(phoneStr)){
      return false;
    }
    return true;
    // YOUR CODE HERE
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    var cb = function(data) {
      // YOUR CODE HERE
      var message = new Message (this.phoneInputField.val(), this.messageInputField.val());
      this.messageList.append(message.render());
    ...
    $.ajax({
      ...
      url: this.apiUrl + '/' + this.accountId + '/' + this.accountId + '/Messages',
      //"YOUR CODE HERE",
      // Exercise 6.C `data`

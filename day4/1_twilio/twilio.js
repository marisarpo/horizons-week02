...
twilio.accountId = "AC12a6c9955346fbb08872f62061273102";
twilio.authToken = "832e92c1295e8ff4c3c136b280bd6af6";
twilio.fromNumber = "14698047151";
...
twilio.TwilioShoutout.prototype = {
    ...
    initialize: function() {
        ...
        //       console.log("message-input button test");
    ...
    validateMessageField: function(textStr) {
        //   var checkField = $.trim(textStr);
        //   console.log("validateMessageField after message trim check");
        //   if (checkField.val() == "") {
        //       return true;
        //   } else {
        //       return false;
    ...
    validatePhoneField: function(phoneStr) {
        //   var checkPhone =$.trim(phoneStr);
        //   console.log("validatePhoneField after phone trim check");
        //   if (checkPhone.val() == "" || checkPhone.val().toString().length !== 10) {
        //       return false;
        //   } else {
        //       for (var k = 0; k < checkPhone.val().toString().length; k++) {
        //           if (parseInt(checkPhone.val().toString().charAt(k)).isNan())
        //             return false;
        //       }
        //   }
        //   return true;
        console.log("validatePhoneField")
        if (this.validateMessageField(phoneStr)) {
            for (var i = 0; i < phoneStr.length - 1; i++) {
                if (isNaN(phoneStr.charAt(i))) {
                    console.log(phoneStr[i]);
                    return false;
                }
            }
            return true;
    ...
    handleMessageSend: function(evt) {
        ...
        //   var messageFieldInput = $(".message-list").val();
        //   var phoneFieldInput = $(".phone-input-field").val();
        //   if (validateMessageField(messageFieldInput) && validatePhoneField(messageInputField)) {
        //       this.sendMessage(phoneFieldInput, messageFieldInput)
        //       this.clearField(this.messageInputField);
        //   } else {
        //       throw ("Please enter a valid phone number and a valid message!");
        //   }
    ...
    sendMessage: function(toNumber, messageBody) {
        ...
        var cb = function(data) {
            // YOUR CODE HERE
            var msg = new Message(twilio.fromNumber, messageBody);

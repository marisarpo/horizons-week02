...
twilio.accountId = "AC8c28baba51ba1d3856bc815033f70892";
twilio.authToken = "bcf9c4d9f67249e1122065b6efb60d6f";
twilio.fromNumber = "15415792082";
...
twilio.TwilioShoutout.prototype = {
  ...
  handleMessageSend: function(evt) {
    ...
    var valMessage = this.messageInputField.val();
    var valPhone = this.phoneInputField.val();

    console.log(this.validateMessageField(valMessage));
    console.log(this.validatePhoneField(valPhone));

    if(this.validateMessageField(valMessage) && this.validatePhoneField(valPhone)) {
      this.sendMessage(valPhone, valMessage);
    }

...
twilio.TwilioShoutout.prototype = {
  ...
  validatePhoneField: function(phoneStr) {
	...
	// Write a method that will check the validity of the phone and message fields, and if they're both valid, calls the Twilio API with our data 
  // so that it can send a text to your phone. If not, it should throw an error "Invalid fields";
	// 
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    // This callback should create a new Message object and generate a 
    // JQuery object using its render() method. It should append the gnerated JQuery object to the DOM messageList.
    var cb = function(data) {
			var message = new Message(this.fromNumber, messageBody)
      messageList.append(message.render())
    };
...
// Nice, you got to the end. Right now, the test is instantiating the app and allowing you to run it, but if you wanted to use it yourself 

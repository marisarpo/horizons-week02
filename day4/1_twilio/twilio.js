...
twilio.accountId = "AC865b74eadb12a0470328c6fb0291ee3e";
twilio.authToken = "44e7cb9bb099896e6cd949a682bbffa5";
twilio.fromNumber = "18442876556";
...
twilio.TwilioShoutout.prototype = {
  ...
  handleMessageSend: function(evt) {
    ...
    if(this.validatePhoneField(phoneTemp) && this.validateMessageField(msgTemp)){
      this.sendMessage(phoneTemp, msgTemp);

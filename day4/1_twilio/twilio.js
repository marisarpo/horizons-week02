...
twilio.accountId = "AC9360b3d423314abecd403b9f9fa4cc75";
twilio.authToken = "0795e22d4e65cc107c611f544e5988ab";
twilio.fromNumber = "17868013830";
...
twilio.TwilioShoutout.prototype = {
  ...
  // Write a function that takes a JQuery input field and clears the text inside it. It should not return anything.
  //
	// hint. use $.trim(), see https://api.jquery.com/jQuery.trim/
  // hint. what does it mean to `clear` a field? Set it to an empty string.
  // hint. use .val() to get (and set) the value of an input object!
  ...
  handleMessageSend: function(evt) {
    ...
    var number = this.validatePhoneField(this.phoneInputField.val());
    var message = this.validateMessageField(this.messageInputField.val());
    if(number && message){

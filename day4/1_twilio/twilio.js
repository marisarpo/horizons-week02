...
twilio.accountId = "ACaf5640d4477e067800428af5251614aa";
twilio.authToken = "26c8f6b61e7be69f5d626c2e48177594";
twilio.fromNumber = "19706166852";
...
twilio.TwilioShoutout.prototype = {
  ...
  handleMessageSend: function(evt) {
    ...
    // YOUR CODE HERE
    var phoneVal = this.phoneInputField.val();
    var messageVal = this.messageInputField.val();
    if(this.validatePhoneField(phoneVal) && this.validateMessageField(messageVal)){
      this.sendMessage(phoneVal, messageVal)

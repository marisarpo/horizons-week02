...
twilio.accountId = "ACabb79cd54d0582e4dcab8450bc2d40bf";
twilio.authToken = "65b73850f23ab0a0d3b948355390c67b";
twilio.fromNumber = "14152127426";
...
twilio.TwilioShoutout.prototype = {
  ...
  validatePhoneField: function(phoneStr) {
    ...
    var regex = /^\d+$/;
    return !!$.trim(phoneStr).length && (regex.test(phoneStr));
  },
  ...
  handleMessageSend: function(evt) {
    ...
    var toMsg = this.messageInputField.val();
    if (this.validatePhoneField(toPhone) &&
      this.validateMessageField(toMsg)) {
      this.sendMessage(toPhone, toMsg);
      this.clearField(this.messageInputField);
      return;
    }
    // console.log(this.validatePhoneField(toPhone));


    // if (this.validatePhoneField(this.phoneInputField) && this.validateMessageField(this.messageInputField)){
    //   this.sendMessage(this.number, this.messageInputField);
    //   this.clearField(this);
    //   return;
    // }
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    var cb = function(data) {
      ...
      var render = msg.render();
      messageList.append(render);

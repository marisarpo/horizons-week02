...
twilio.accountId = "AC9cfbc85f4972a3aea84fa3f48eaae57d";
twilio.authToken = "300070c7e430edda7d6a606e6881072a";
twilio.fromNumber = "14044767410";
...
twilio.TwilioShoutout.prototype = {
  ...
  validateMessageField: function(textStr) {
    // YOUR CODE HERE
    return (textStr !== "") && (textStr !== undefined);
  },
  ...
  validatePhoneField: function(phoneStr) {
    // YOUR CODE HERE
    if (phoneStr === "" || phoneStr === undefined) return false;
  ...
  handleMessageSend: function(evt) {
    ...
    // YOUR CODE HERE
    if (this.messageInputField.val() && this.phoneInputField.val()) {
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    $.ajax({
      ...
      url: this.apiUrl + '/Accounts/' + acctId + '/SMS/Messages',
			// Exercise 6.C `data`

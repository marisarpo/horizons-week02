...
twilio.accountId = "ACad9553f01cb4ae87fc4932701778caba";
twilio.authToken = "26775906648cb02c42c571fc98e4ce5c";
twilio.fromNumber = "7135976585";
...
twilio.TwilioShoutout.prototype = {
  ...
  validatePhoneField: function(phoneStr) {
    ...
    for(var i=0;i<phoneStr.length;i++){
      if(parseFloat(phoneStr[i]).toString()=='NaN'){
        return false;
      }
    }
    return true;
  ...
  handleMessageSend: function(evt) {
    ...
    if(!this.validatePhoneField(this.phoneInputField.val()) ||
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    $.ajax({
      ...
      url: 
        this.apiUrl + '/Accounts/'+this.accountId+'/Messages',
			// Exercise 6.C `data`
...
var Message = function(sender, body) {
  this.sender = "1"+sender; // NOTE: THIS IS JUST THE NUMBER YOU ARE SENDING A TEXT TOO
  this.body = body;
};

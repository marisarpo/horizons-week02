...
twilio.accountId = 'ACc62d9f4a57aea579d5bc6927c1d04b85';
twilio.authToken = '709fcf842de2da4bdb78d734c93fb804';
twilio.fromNumber = '+13092132791';
...
twilio.TwilioShoutout.prototype = {
  ...
  validateMessageField: function(textStr) {
    // YOUR CODE HERE
    if(textStr === '' || textStr.trim() === '') return false;
    return true;
  },
  ...
  validatePhoneField: function(phoneStr) {
    ...
    if(phoneStr === '' || phoneStr.trim() === '' || phoneStr.match(/[^$,.\d]/)) return false;
    return true;
  },
  ...
  handleMessageSend: function(evt) {
    var phoneStr = $('.phone-input-field').val();
    var messageStr = $('.message-input-field').val();
    if(!this.validatePhoneField(phoneStr) || !this.validateMessageField(messageStr)){
      throw 'your bitch';
    }
  ...
  sendMessage: function(toNumber, messageBody) {
    ...
    var cb = function(data) {
      ...
      var rendered = newMessage.render();

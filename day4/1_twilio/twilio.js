...
twilio.accountId = "ACcbc57dec2482a3711555656c33e90cde";
twilio.authToken = "e40f6d80ef65483b10094054a3b3b285";
twilio.fromNumber = "19179243449";
...
twilio.TwilioShoutout.prototype = {
  ...
  handleMessageSend: function(evt) {
    ...
    var goodPhone = this.validatePhoneField(number);
    var goodMessage = this.validateMessageField(message);
    if (!goodPhone || !goodMessage) throw "Invalid fields";

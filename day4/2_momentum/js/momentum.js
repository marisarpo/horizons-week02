...
momentum.Core.prototype = {
	...
	// TIME DEALT WITH IN HTML SCRIPT
	// `setQuote` method
	// This method should set the `quoteStr` property of the momentum core. This method 
	// will be used as the callback for quoteCtrl's `fetchQuote` function.
	// 
	// hint. check out the `Date` object! Use `getHours` and `getMinutes`.
	// hint. figure out what kind of response the quoteData is going to be, and see how 
	// you might be able to access the quote of the day from that.
	setQuote: function(quoteData) {
	// YOUR CODE HERE
		$('#quote').html(quoteData)
	},
	// `setWeather` method
	// This method should set the `weatherStr` property of the momentum core. This method 
	// will be used as the callback for weatherCtrl's `fetchWeather` function.
	// 
	// hint. figure out what kind of response the weatherData is going to be, and see how 
	// you might be able to access the quote of the day from that.
	setWeather: function(weatherData) {
	// YOUR CODE HERE
		$('#weather').html(weatherData[0]+' | '+weatherData[1]+' degrees')
	},
	// `updateTime` method
	...
	// YOUR CODE HERE
		this.setWeather(momentum.weatherCtrl.prototype.fetchWeather())
	},
	// `updateQuote` method
	...
	// YOUR CODE HERE
		this.setQuote(momentum.quoteCtrl.prototype.fetchQuote())
	},
	// `start` method

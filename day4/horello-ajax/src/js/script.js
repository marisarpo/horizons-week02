...
function renderBoard(board) {
  // YOUR CODE HERE
  var html = `<div id=${board.id} class="board"></div>`
  $('#boardAnchor').empty();
...
function renderCard(card) {
  ...
  var html =
  `<div id=${id} class="card" data-card-desc=${description} data-card-name=${name} data-list-id=${listId} data-card-id=${id}>
    <div class="card-body">
      <button type="button" class="close" id="deleteCard" data-dismiss="modal">
        <span>&times;</span>
      </button>
      ${name}
    </div>

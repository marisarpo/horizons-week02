...
momentum.Core.prototype = {
  ...
  setWeather: function(weatherData) {
		var currTempC = Math.floor(weatherData.main.temp - 273.15);
    console.log(currTempC);
    this.weatherStr = currTempC;
  ...
  updateWeather: function() {
    var realthis = this;
    //this.weatherCtrl.fetchWeather.bind.apply(this.setWeather);
    this.weatherCtrl.fetchWeather(this.setWeather.bind(this));
    //this.weatherCtrl.fetchWeather.bind(this);
  ...
  render: function() {
    ...
    this.weatherEl.text(this.weatherStr).append('&#8451;');
  }
};
